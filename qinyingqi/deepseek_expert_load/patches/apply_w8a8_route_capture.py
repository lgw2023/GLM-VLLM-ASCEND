#!/usr/bin/env python3
"""Apply the DeepSeek-V4 W8A8 routed-expert hook to vLLM-Ascend v0.22.1rc1."""
...
PATCH_MARKER = "# DEEPSEEK_V4_W8A8_ROUTE_CAPTURE_V2"
ANCHOR = (
...
def main() -> int:
    ...
    if args.verify:
        ...
        print(f"DEEPSEEK_W8A8_ROUTE_CAPTURE_PATCH_OK path={path}")
        return 0
    ...
    print(f"DEEPSEEK_W8A8_ROUTE_CAPTURE_PATCH_APPLIED path={path}")
    return 0
